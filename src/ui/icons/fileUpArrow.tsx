...
export interface FileUpArrowProps extends BaseIconProps {}

export function FileUpArrow(props: FileUpArrowProps) {
  return (
    <BaseIcon {...props}>
      <path d='M208 88h-56V32Z' opacity={DEFAULT_OPACITY} />
